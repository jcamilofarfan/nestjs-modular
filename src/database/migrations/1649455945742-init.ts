...
export class init1649455945742 implements MigrationInterface {
  name = 'init1649455945742';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "brands" ADD "image" character varying(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "brands" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "brands" ADD "updated_ at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "products_has_categories" ADD CONSTRAINT "FK_e832d974c42f6fc3cbc70ace82a" FOREIGN KEY ("category_id") REFERENCES "brands"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "brands" DROP COLUMN "updated_ at"`);
    await queryRunner.query(`ALTER TABLE "brands" DROP COLUMN "updated_at"`);
    await queryRunner.query(`ALTER TABLE "brands" DROP COLUMN "image"`);
    await queryRunner.query(
      `ALTER TABLE "brands" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
